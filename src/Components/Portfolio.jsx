...
const projectList = [
  {
    ...
    description:
      "Its a box office web app, on which user get information about shows and actors. Built using ReactJS, HTML, CSS, API. ",
    url: "https://mayurnikam989.github.io/Box-Office-App/",
  },
  {
